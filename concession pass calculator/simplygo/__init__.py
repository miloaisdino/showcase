...
class Ride:
    ...
    def get_train_stations(self):
        return self.simplygo_api.query_api(Constants.API_ABT_GET_TRAIN_STATIONS, None, HttpMethod.GET)

    def get_recipient(self):
        return self.simplygo_api.query_api(Constants.API_ABT_GET_RECIPIENT)

    def get_monthly_usages(self):
        return self.simplygo_api.query_api(Constants.API_ABT_GET_MONTHLY_USAGES)
